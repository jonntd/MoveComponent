...
MoveComponentTool::MoveComponentTool(){
...
void* MoveComponentTool::creator(){
	return new MoveComponentTool;
}

bool MoveComponentTool::isUndoable() const{
	return true;
}

MStatus MoveComponentTool::finalize(){
...
MStatus MoveComponentTool::doIt(const MArgList& args){
	return MStatus::kSuccess;
}

MStatus MoveComponentTool::undoIt(){
	MStatus status(MStatus::kSuccess);
...
MStatus MoveComponentTool::redoIt(){
	MStatus status(MStatus::kSuccess);
...
// Tool Settings
void MoveComponentTool::setData(MoveComponentData* toolData) {
	m_data = toolData;
...
MStatus MoveComponentTool::transformComponent()
{
	MStatus status(MStatus::kSuccess);
